...
public class DemoSynchronize {
    ...
    public void demoSynchronize(Context context){
        ...
        */
        ...
        deliverableVoList.add(new DeliverableVo("T17", "COMITE TECNICO", "REDUÇÃO DE AJUSTES POR FRAUDE", "ENCAMINHAR CRONOGRAMA E PLANO DE AÇÃO, BEM COMO O ACOMPANHAMENTO DAS AÇÕES REALIZADAS PARA REDUZIR OS AJUSTES COM O MOTIVO DE FRAUDE A FIM DE QUE O VALOR TOTAL DE AJUSTES ATINJA A META DE NO MÁXIMO 1% DA RECEITA", "AVALIAR VALOR DA AÇÃO", "Open", "06/05/2016", "JOSE APARECIDO PRADO", "2"));

        deliverableVoList.add(new DeliverableVo("T18", "COMITE TECNICO", "REDUÇÃO DE AJUSTES COM MOTIVO DE MULTA", "ENCAMINHAR CRONOGRAMA E PLANO DE AÇÃO PARA REDUZIR OS AJUSTES COM O MOTIVO DE MULTA", "AVALIAR VALOR DA AÇÃO", "Open", "31/03/2016", "SYBELLE", "2"));

        deliverableVoList.add(new DeliverableVo("T19", "COMITE TECNICO", "Utilização de licenças do HSS para assinantes que não trafegam no 4G.", "Avaliar usuários GE e PME que não trafegam 4G porém utilizam licenças HSS e alternativa para atender a alocação de licenças de acordo coma necessidade.", "[07/04] - Na ausência de Edilson Briotto que está em férias, agendada reunião com Wanderson Alexandre Oliveira (11 992158418).", "Open", "14/04/2016", "Edilson Briotto", "2"));

        deliverableVoList.add(new DeliverableVo("T20", "COMITE TECNICO", "Queda no tráfego de dados no último dia do mês.  - Quedas: - 30/11/2015 - 31/12/2015 - 31/01/2016 - 29/02/2016 - ", "Avaliar se temos algum problema técnico que leva a queda de tráfego de dados de clientes pós-pago no último dia do mês.", "AVALIAR VALOR DA AÇÃO -  - [07/04] - Análise preliminar de ENG (mês de Março) não iodentifcou indícios de falha.  - Amorim solicitou acompnhamento do faturamento do mês de Março com os ciclos que fecham ao lonog de Abril. - Alexandre Martins seguirá com avaliação d", "Open", "14/04/2016", "Alexandre Martins", "2"));

        deliverableVoList.add(new DeliverableVo("T21", "COMITE TECNICO", "Ficha 338 - Assinantes Street Seller sem faturamento", "", "Fernanda Santos Rodrigues (MKT): Trazer fichas assinadas", "Open", "31/12/2016", "Fernanda Santos", "2"));

        deliverableVoList.add(new DeliverableVo("T22", "COMITE TECNICO", "REDUÇÃO DE OFENSORES DE AJUSTE", "ENCAMINHAR CRONOGRAMA E PLANO DE AÇÃO, BEM COMO O ACOMPANHAMENTO DAS AÇÕES REALIZADAS PARA REDUZIR OS OFENSORES DE AJUSTES PARA OS SEGMENTOS PF E PME A FIM DE QUE O VALOR TOTAL DE AJUSTES ATINJA A META DE NO MÁXIMO 1% DA RECEITA - (LÊ-SE COMO OFENSORES DE A", "AVALIAR VALOR DA AÇÃO -  - [05/04] - Mover para comitê técnico. -  - [04/03] - Solicitado por GAR por frente de redução de ajustes.", "Open", "11/03/2016", "SYBELLE", "2"));
        ...
        deliverableVoList.add(new DeliverableVo("T24", "COMITE TECNICO", "REDUÇÃO DE AJUSTES RECORRENTES", "ENCAMINHAR CRONOGRAMA E PLANO DE AÇÃO, BEM COMO O ACOMPANHAMENTO DAS AÇÕES REALIZADAS PARA REDUZIR OS AJUSTES RECORRENTES (PF/PME/PRÉ) A FIM DE QUE O VALOR TOTAL DE AJUSTES ATINJA A META DE NO MÁXIMO 1% DA RECEITA", "AVALIAR VALOR DA AÇÃO -  - [05/04] - Mover para comitê técnico. -  - [10/03] - Luis Amaral direcionou para Sybele em ACL. Alinhar. -  - [04/03] - Solicitado por GAR por frente de redução de ajustes.", "Open", "11/03/2016", "LUIS HENRIQUE DA SILVA AMARAL", "2"));

        deliverableVoList.add(new DeliverableVo("T25", "COMITE TECNICO", "Composição de oferta Claro Turbo", "", "Data prevista para o término da Recuperação, conforme controle de GAR.", "Open", "05/04/2016", "", "2"));

        deliverableVoList.add(new DeliverableVo("T26", "COMITE TECNICO", "Clientes PABX sem cadastro no mobile e ativo na central", "", "Data prevista para o término da Recuperação, conforme controle de GAR.", "Open", "08/04/2016", "", "2"));

        deliverableVoList.add(new DeliverableVo("T27", "COMITE TECNICO", "Ressarcimento - Falha do fornecedor Promon", "", "Data prevista para o término da Recuperação, conforme controle de GAR.", "Open", "14/04/2016", "", "2"));

        deliverableVoList.add(new DeliverableVo("T28", "COMITE TECNICO", "Venda de Aparelhos com desconto para clientes inadimplentes [venda irregular]", "", "Data prevista para o término da Recuperação, conforme controle de GAR.", "Open", "30/06/2016", "", "2"));

        deliverableVoList.add(new DeliverableVo("T29", "COMITE TECNICO", "Descontos dependentes Claro Online turbo", "", "Data prevista para o término da Recuperação, conforme controle de GAR.", "Open", "11/04/2016", "", "2"));

        deliverableVoList.add(new DeliverableVo("T30", "COMITE TECNICO", "Oportunidade de receita com o pacote “Magazine Luiza”", "", "Data prevista para o término do Diagnóstico, conforme controle de GAR.", "Open", "15/04/2016", "", "2"));

        deliverableVoList.add(new DeliverableVo("T31", "COMITE TECNICO", "Cliente Pré-Pago com pacote de bônus do Controle ", "", "Data prevista para o término do Diagnóstico, conforme controle de GAR.", "Open", "11/04/2016", "", "2"));

        deliverableVoList.add(new DeliverableVo("T32", "COMITE TECNICO", "Ressarcimento - Interrupção do serviço de ativação de novas linhas via plataforma ODA", "", "Data prevista para o término do Diagnóstico, conforme controle de GAR.", "Open", "30/05/2016", "", "2"));

        deliverableVoList.add(new DeliverableVo("T33", "COMITE TECNICO", "Queda na recarga do Pré-Pago no dia 27/02", "", "Data prevista para o término do Diagnóstico, conforme controle de GAR.", "Open", "30/04/2016", "", "2"));

        deliverableVoList.add(new DeliverableVo("T34", "COMITE TECNICO", "Clientes com pacote Magazine sem limite de navegação no RG7", "", "Data prevista para o término do Diagnóstico, conforme controle de GAR.", "Open", "30/04/2016", "", "2"));

        deliverableVoList.add(new DeliverableVo("T35", "COMITE TECNICO", "Descontos retenção inseridos fora da vigência promocional", "", "Data prevista para o término do Diagnóstico, conforme controle de GAR.", "Open", "30/04/2016", "", "2"));
